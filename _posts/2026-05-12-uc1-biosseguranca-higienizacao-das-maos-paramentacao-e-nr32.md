---
title: "UC1: Biossegurança na Radiologia — Higienização das Mãos (ANVISA/OMS), Paramentação, EPIs Plumbíferos e Diretrizes da NR-32"
date: 2026-05-12 10:00:00 -0300
categories: [UC1, Biosseguranca e Radioprotecao]
tags: [biosseguranca, higienizacao-das-maos, anvisa, nr-32, epis-plumbiferos, protecao-radiologica, assepsia, senac]
description: "Um guia técnico e normativo sobre biossegurança no radiodiagnóstico: protocolo de higienização das mãos (ANVISA/OMS), regras da NR-32, cuidados vitais com aventais de chumbo e desinfecção de equipamentos."
mermaid: true
image:
  path: /assets/img/posts/uc1-paramentacao-avental-chumbo.jpg
...
```mermaid
flowchart LR
    A["Paciente A<br/>(Potencial portador)"] -->|Toque sem luva/lavagem| B["Chassi / Mesa Bucky<br/>(Fômites contaminados)"]
    B -->|Manipulação técnica| C["Mãos do Técnico"]
    C -->|Sem higienização| D["Painel de Comando / Teclado"]
    D -->|Próximo exame| E["Paciente B<br/>(Infecção Cruzada)"]
```
...
```mermaid
flowchart TD
    M1["1. ANTES do contato com o paciente<br/><i>(Antes de tocar no paciente para anamnese/posicionamento)</i>"] --> M2["2. ANTES da realização de procedimento asséptico<br/><i>(Manipulação de cateteres, curativos, contrastes)</i>"]
    M2 --> M3["3. APÓS risco de exposição a fluidos corporais<br/><i>(Sangue, secreções, vômito, contraste extravasado)</i>"]
    M3 --> M4["4. APÓS contato com o paciente<br/><i>(Ao término da realização das incidências)</i>"]
    M4 --> M5["5. APÓS contato com superfícies e áreas próximas<br/><i>(Ao tocar na mesa, Bucky, estativa, colimador ou chassi)</i>"]
```
...
![Ensaio prático em laboratório para verificação de cobertura total na fricção antisséptica](/assets/img/posts/uc1-higienizacao-maos-teste-pratico.jpg)
...
![Diretrizes de vestimenta e postura profissional segundo a NR-32](/assets/img/posts/uc1-nr32-adorno-zero.jpg)
