---
title: "UC1: Terminologia Anatômica, Planos, Incidências e Movimentos no Posicionamento Radiográfico"
date: 2026-05-08 09:00:00 -0300
categories: [UC1, Posicionamento]
tags: [posicionamento, terminologia-anatomica, planos-anatomicos, marcos-anatomicos, incidencias, ap-pa, perfil, obliqua, axial, bontrager, senac]
description: "Tratado completo de terminologia e fundamentos do posicionamento radiográfico: posição anatômica universal, planos corporais, marcos de superfície, catálogo das incidências, movimentos articulares e regras de ouro da literatura técnica."
mermaid: true
image:
  path: /assets/img/posts/marcos-anatomicos-cabeca.jpg
  alt: Slide de aula ilustrando os marcos anatômicos de crânio e face para posicionamento radiográfico
---
...
```mermaid
flowchart TD
    A["Planos Anatômicos Fundamentais"] --> B["Plano Médio Sagital (PMS)<br/>Divide em Direita e Esquerda"]
    A --> C["Plano Coronal / Frontal (PMC)<br/>Divide em Anterior e Posterior"]
    A --> D["Plano Transversal / Horizontal / Axial<br/>Divide em Superior e Inferior"]
    A --> E["Plano Oblíquo<br/>Corte angular intermediário"]
```
...
![Marcos anatômicos de superfície da cabeça e pescoço](/assets/img/posts/marcos-anatomicos-cabeca.jpg)
...
```mermaid
flowchart TD
    A["Catálogo das Incidências"] --> B["Ântero-Posterior (AP)<br/>Entrada Anterior ➔ Saída Posterior"]
    A --> C["Póstero-Anterior (PA)<br/>Entrada Posterior ➔ Saída Anterior"]
    A --> D["Laterais / Perfil<br/>Trajetória Transversal"]
    A --> E["Oblíquas (AP / PA)<br/>Rotação a 45° (Medial/Lateral)"]
    A --> F["Axiais / Semiaxiais<br/>Angulação Longitudinal RC ≥ 10°"]
    A --> G["Tangenciais<br/>Feixe roça a curvatura sem sobreposição"]
```
...
<div class="row">
  <div class="col">
    <p><strong>Incidência AP (Frente para Trás):</strong></p>
    <img src="/assets/img/posts/incidencia-ap.jpg" alt="Incidência Ântero-Posterior AP" />
  </div>
  <div class="col">
    <p><strong>Incidência PA (Trás para Frente):</strong></p>
    <img src="/assets/img/posts/incidencia-pa.jpg" alt="Incidência Póstero-Anterior PA" />
  </div>
</div>
...
![Incidência lateral ou perfil](/assets/img/posts/incidencia-lateral-perfil.jpg)
...
![Incidências oblíquas de mão e pé](/assets/img/posts/incidencias-obliquas.jpg)
...
![Rotação versus inclinação de planos](/assets/img/posts/rotacao-inclinacao-planos.jpg)
...
![Eversão versus inversão do pé e tornozelo](/assets/img/posts/eversao-inversao-tornozelo.jpg)
...
![Protração e retração mandibular](/assets/img/posts/protracao-retracao-mandibular.jpg)
